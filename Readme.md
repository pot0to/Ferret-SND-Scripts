...
stellar_missions.medicine_to_drink = "" -- CURRENTLY NOT WORKING leave blank if you don't want to drink medication 
...
stellar_missions.missions_to_medicate_on = { -- CURRENTLY NOT WORKING Chooses which missions to medicate on, will only medicate on things in this list
    "Gathering Miscellany",
}
